/* global canvas, getPos, isDrawing:writable, currentMaterial, M, eraserSize, brushSize, width, height, grid, heatMap, liquidDir, fireworkVel, AudioEngine */
/* global zoom:writable, offsetX:writable, offsetY:writable, autoSaveIfEditing, enableAudioToggles, simulationSpeed, updatePhysics, draw, fpsDisplay */
/* global resetWorld, renderTools, initUI */
...
(async () => {
    // "Open Twice" Fix: Reload once per session to prevent black screen issues
    // on some devices.
