...
<body class="w-full h-full text-white font-pixel selection:bg-none cursor-crosshair">
        ...
        <div class="flex justify-between items-start w-full">
            ...
            <div class="pointer-events-auto-child relative">
                ...
                <div id="worldsPanel"
                    ...
                    <button onclick="loadWorld('forest')"
                        class="text-left hover:text-yellow-400 py-1 border-b border-white/10">🌲 WALD</button>
                    <button onclick="loadWorld('village')"
                        class="text-left hover:text-yellow-400 py-1 border-b border-white/10">🏠 DORF</button>
                    <button onclick="loadWorld('island')"
                        class="text-left hover:text-yellow-400 py-1 border-b border-white/10">🏝️ INSEL</button>
                    <button onclick="loadWorld('volcano')"
                        class="text-left hover:text-yellow-400 py-1 border-b border-white/10">🌋 VULKAN</button>
                    <button onclick="loadWorld('cave')"
                        class="text-left hover:text-yellow-400 py-1 border-b border-white/10">⛏️ HÖHLE</button>
                    <button onclick="loadWorld('sky')" class="text-left hover:text-yellow-400 py-1">☁️ HIMMEL</button>
                </div>
            </div>
            ...
            <div class="pointer-events-auto-child relative flex flex-col items-end gap-2">
                ...
                <div id="settingsPanel"
                    ...
                    <div class="flex flex-col gap-1">
                        <div class="flex justify-between"><span>FEUER STÄRKE</span><span id="disp-fire"
    ...
    <div id="bigInventory"
        ...
        <p class="text-gray-500 text-[8px] mb-4 uppercase tracking-wider">Wähle bis zu 2 Elemente aus</p>
